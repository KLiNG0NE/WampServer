...
Dieses Repository beinhaltet Sprachdateien für die Software WampServer. Du kannst die Dateien auf GitHub über "Code -> Download ZIP" herunterladen.

Die Dateien werden anschließend in das Verzeichnis der WampServer-Installation Beispielsweise ``C:\wamp64`` entpackt.
